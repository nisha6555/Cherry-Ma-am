    ...
    <div className="flex-1 flex flex-col justify-between z-10 w-full px-4 py-4 md:px-6 select-none bg-[#f8fafc] overflow-y-auto max-h-[100dvh] font-sans text-slate-800 antialiased" id="premium-study-desk-root">
      ...
      <div className="space-y-4 flex-1 flex flex-col justify-start overflow-y-auto pr-0.5 pb-4">
        ...
        {/* =========================================
            ...
            ========================================= */}
        <div className="bg-white border border-slate-200/80 rounded-2xl sm:rounded-3xl p-2.5 sm:p-3 shadow-xs text-left space-y-2">
          <div className="flex items-center justify-between px-0.5">
            <h4 className="text-[10px] font-mono font-black uppercase text-[#0a3641] tracking-wider flex items-center gap-1.5">
              <span className="w-1.5 h-1.5 rounded-full bg-[#c4f500]" /> Learning Mode / मोड चुनें
            </h4>
          ...
          {/* Horizontally Scrollable 6-Item Learning Mode Bar */}
          <div className="flex items-center gap-1.5 p-1.5 bg-slate-100/90 rounded-xl sm:rounded-2xl border border-slate-200/70 shadow-inner overflow-x-auto scrollbar-none scroll-smooth">
            <button
              type="button"
              onClick={() => {
                setUploadMode("guide");
              ...
              className={`shrink-0 py-2 px-3 sm:px-3.5 rounded-lg sm:rounded-xl flex items-center justify-center gap-1.5 transition-all duration-200 cursor-pointer text-center select-none whitespace-nowrap ${
                uploadMode === "guide" || uploadMode === "socratic"
                  ? "bg-gradient-to-br from-[#0a3641] to-teal-950 text-[#c4f500] shadow-sm font-bold scale-[1.02]"
                  : "text-slate-600 hover:text-slate-900 hover:bg-white/60 font-semibold"
              }`}
            >
              <span className="text-xs sm:text-sm">🧭</span>
              <span className="text-[11px] sm:text-xs font-bold tracking-tight">Guide</span>
            </button>
            <button
              type="button"
              onClick={() => {
              ...
              className={`shrink-0 py-2 px-3 sm:px-3.5 rounded-lg sm:rounded-xl flex items-center justify-center gap-1.5 transition-all duration-200 cursor-pointer text-center select-none whitespace-nowrap ${
                uploadMode === "explain"
                  ? "bg-white text-[#0a3641] shadow-sm border border-slate-200/90 font-bold scale-[1.02]"
                  : "text-slate-600 hover:text-slate-900 hover:bg-white/60 font-semibold"
              }`}
            >
              <span className="text-xs sm:text-sm">📖</span>
              <span className="text-[11px] sm:text-xs font-bold tracking-tight">Explainer</span>
            </button>
            <button
              type="button"
              onClick={() => {
            ...
            >
              <span className="text-xs sm:text-sm">🔍</span>
              <span className="text-[11px] sm:text-xs font-bold tracking-tight">Mistake</span>
            </button>
            <button
              type="button"
              onClick={() => {
            ...
            >
              <span className="text-xs sm:text-sm">💡</span>
              <span className="text-[11px] sm:text-xs font-bold tracking-tight">Doubt</span>
            </button>
            <button
              type="button"
              onClick={() => {
            ...
            >
              <span className="text-xs sm:text-sm">📝</span>
              <span className="text-[11px] sm:text-xs font-bold tracking-tight">HW Maker</span>
            </button>
            <button
              type="button"
              onClick={() => {
          ...
          <div className="px-1 text-[9.5px] text-slate-500 truncate sm:whitespace-normal">
            {uploadMode === "guide" || uploadMode === "socratic" ? (
              <span><strong className="text-[#0a3641]">Problem Guide (गाइड):</strong> Step-by-step deconstruction & Socratic micro-hints for numericals.</span>
            ) : uploadMode === "explain" ? (
              ...
              <span><strong className="text-[#0a3641]">Find Mistake:</strong> Scans notebook page, isolates calculation slips, and demonstrates correction.</span>
            ) : uploadMode === "doubt" ? (
        ...
        {uploadMode === "guide" || uploadMode === "socratic" ? (
          ...
          <div className="bg-white border border-slate-200/80 rounded-[28px] p-4 sm:p-5 shadow-xs text-left space-y-4">
            {/* Studio Header */}
            <div className="flex flex-wrap items-center justify-between gap-2 border-b border-slate-100 pb-3">
              <div className="flex items-center gap-2">
                <span className="w-2.5 h-2.5 rounded-full bg-amber-500 animate-pulse" />
                <h4 className="text-xs sm:text-sm font-mono font-bold uppercase text-[#0a3641] tracking-wider flex items-center gap-2">
                  <span>⚡ Visual Cheat Sheet Studio</span>
                  <span className="text-[9px] bg-amber-100 text-amber-800 font-bold px-2 py-0.5 rounded-full tracking-normal capitalize font-sans">
              ...
              {cheatSheetData && (
                <div className="flex items-center gap-2">
                  <button
                    ...
                    className="px-3 py-1.5 bg-[#0a3641] hover:bg-[#114956] text-[#c4f500] rounded-xl text-xs font-bold transition-all cursor-pointer flex items-center gap-1.5 shadow-xs active:scale-95"
                  >
            ...
            {loadingCheatSheet ? (
              <div className="py-14 px-6 flex flex-col items-center justify-center text-center space-y-4 bg-slate-50/70 rounded-3xl border border-slate-200">
              ...
              <div className="space-y-4">
                ...
                <div
                  ...
                  className="border-2 border-dashed border-amber-300 hover:border-amber-500 bg-amber-50/40 hover:bg-amber-50/70 rounded-2xl flex flex-col items-center justify-center text-center p-6 space-y-3 transition-all duration-300 cursor-pointer group min-h-[140px] active:scale-[0.99] relative shadow-2xs"
                >
                  <input
                    type="file"
                  ...
                  />
                  <div className="p-3.5 rounded-2xl bg-white border border-amber-200 group-hover:scale-105 transition-transform shadow-xs text-amber-600">
                    ...
                    <div className="space-y-1 z-10">
                      <p className="text-[11px] font-black text-slate-800 leading-snug">
                        {uploadMode === "mistake" 
                          ...
                          : uploadMode === "doubt"
                          ? "Upload Doubt Sheet, Question Paper or Handwritten Problem"
      ...
      {/* =========================================
          ...
          ========================================= */}
      {showTopicPrompt && (
        <div className="fixed inset-0 bg-[#04110e]/75 backdrop-blur-md z-[150] flex items-center justify-center p-4 animate-fade-in">
          <div className="bg-white rounded-[28px] border border-slate-200/80 shadow-2xl w-full max-w-md overflow-hidden animate-scale-up text-left">
            {/* Header */}
            <div className="bg-[#0a3641] px-6 py-4 flex items-center justify-between text-white">
              <div className="flex items-center gap-2">
                ...
                <h3 className="text-xs font-black tracking-widest uppercase">
                  {directStudySubMode === "type" ? "Type Your Topic" : "Direct Study Options"}
                </h3>
              </div>
              <button 
                type="button"
                ...
                className="text-white/70 hover:text-white hover:scale-110 transition-all text-sm font-bold cursor-pointer w-7 h-7 flex items-center justify-center rounded-lg hover:bg-white/10"
              >
                ✕
              </button>
            </div>
            ...
            <div className="p-6 space-y-4">
              {directStudySubMode === "choose" ? (
                <div className="space-y-4">
                  <div className="space-y-1">
                    <p className="text-[10px] font-mono text-[#486a73] font-bold uppercase tracking-wider">
                      Kaise Padhna Chahenge? 🎯✨
                    </p>
                    <p className="text-xs text-slate-600 leading-normal font-medium">
                      Aap direct blackboard par voice se baat karke seekh sakte hain ya topic type karke shuru kar sakte hain:
                    </p>
                  </div>
                  ...
                  <button
                    ...
                    className="w-full p-4 rounded-2xl border-2 border-emerald-500/30 bg-emerald-50/50 hover:bg-emerald-50 hover:border-emerald-600/60 transition-all duration-200 text-left group cursor-pointer shadow-2xs hover:shadow-md flex items-start gap-3.5 relative overflow-hidden"
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center justify-between gap-1">
                        <h4 className="text-xs font-black text-[#0a3641] uppercase tracking-wide">
                          🎙️ Open Blackboard (Voice Direct)
                        </h4>
                        <span className="text-[9px] font-mono font-bold text-emerald-700 bg-emerald-100/90 px-2 py-0.5 rounded-full">
                          Fastest
                        </span>
                      </div>
                      <p className="text-[11px] text-slate-600 font-medium leading-relaxed mt-1">
                        Bina kuch type kiye seedhe Live Blackboard par jaayein. Cherry Ma'am aapse voice me puchhengi aur aap jo bhi bolenge board par draw karke samjhayengi!
                      </p>
                    </div>
                  </button>
                  ...
                  <button
                    ...
                    className="w-full p-4 rounded-2xl border border-slate-200 bg-slate-50/60 hover:bg-slate-50 hover:border-[#0a3641]/40 transition-all duration-200 text-left group cursor-pointer shadow-2xs hover:shadow-md flex items-start gap-3.5"
                  >
                    <div className="w-10 h-10 rounded-xl bg-[#0a3641] text-white flex items-center justify-center shrink-0 shadow-sm group-hover:scale-105 transition-transform">
                      <MessageSquare className="w-5 h-5 text-[#c4f500]" />
                    </div>
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center justify-between gap-1">
                        <h4 className="text-xs font-black text-[#0a3641] uppercase tracking-wide">
                          ✍️ Type Topic Name (Custom Notes)
                        </h4>
                      </div>
                      <p className="text-[11px] text-slate-600 font-medium leading-relaxed mt-1">
                        Apna man-pasand topic type karein (e.g. Newton's Laws, Trigonometry). Cherry Ma'am structured slides aur notes generate karengi.
                      </p>
                    </div>
                  </button>
                </div>
